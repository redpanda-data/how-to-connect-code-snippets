...
Install Go from [go.dev](https://go.dev/doc/install). This example uses the [franz-go](https://github.com/twmb/franz-go) library.
...
Note the username, password, and SASL mechanism the user needs to authenticate. To view existing users or create new ones, go to the [Security section](./security). Make sure the user has ACLs to create, read, and write to a topic named `demo-topic`.

## Create a topic

Create a file named `admin.go` and paste in the following code. In the username and password fields, replace the placeholder text with your actual values. Use the SCRAM mechanism that matches the user's credentials.
...
Create a file named `producer.go` and paste in the following code. In the username and password fields, replace the placeholder text with your actual values. Use the SCRAM mechanism that matches the user's credentials.
...
Create a file named `consumer.go` and paste in the following code. In the username and password fields, replace the placeholder text with your actual values. Use the SCRAM mechanism that matches the user's credentials.
